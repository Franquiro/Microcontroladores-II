...
...Este ejemplo esta como el manual, deberia quitarse el ABAUD (se configuró a 56Kbaud y el UART_EN_LOOPBACK (modo test)
...
// si se utiliza la ventana SIM Uart1 no importa que clock se configure, se verá OK igual
...
UART_DIS_WAKE & UART_EN_LOOPBACK &			// ... y el detalle de los registros está en pag 489/760 hasta 495/760    
...
BRGvalue=32; // Si Fcy=30 MHz, RGG=32 ==> BAUD RATE=56K  (56.8182 K  +1.5% ERROR...
		// ...489/760 a 495/760 del dsPIC30F Familly Reference Manual
...
//	printf("# TCY: %.1f\r\n\n",count);
	...
	baudrate= 30000000.0 /( 16*(float)(BRGvalue+1)); // pag 489/760 a 495/760 del dsPIC30F Familly Reference Manual
	printf("Baud Rate= %f\r\n",baudrate);

	ERROR=((baudrate-56000.0)/56000.0)*100.0;
	printf("ERROR= %1.1f",ERROR);
	printf(" %%\r\n");
	printf("(Ver pag. 487/760 a 495/760 del dsPIC30F Familly Reference Manual)\r\n");
